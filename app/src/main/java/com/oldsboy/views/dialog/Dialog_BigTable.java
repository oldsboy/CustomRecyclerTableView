 ...
 * @Version: 1.0
 */
public class Dialog_BigTable<T> extends BaseDialog {
    ...
    private void initTable() {
        try {
            TableView tableView = new TableView<>(getContext(), table_name, tableHeadList, onToolBarClick, dataSetting, onBtnClickListener);
